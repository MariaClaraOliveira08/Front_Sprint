...
      {/* REMOVIDO: Coração fixo no canto superior direito */}

      <main style={styles.container}>
        <header style={styles.header}>
          <LocationOnOutlinedIcon sx={{ fontSize: 36, color: "#4a5a87" }} />
...
    position: "relative",
  },
  // REMOVIDO: topHeart não é mais necessário
  container: {
    flex: 1,
    padding: 32,
    paddingLeft: 100,
...
  },
  // ESTILOS DO LOGO DA HOME: gap: 10
  header: { display: "flex", alignItems: "center", gap: 10, marginBottom: 40 },
  // ESTILOS DO LOGO DA HOME: margin: 0, fontSize: 26, color: "#4a5a87"
  logoText: { margin: 0, fontSize: 26, fontWeight: 700, color: "#4a5a87" },
  
...
    fontWeight: 500,
  },
  // AJUSTE SCROLL: Removido maxHeight, overflowY e paddingRight
  listaFavoritos: {
    display: "grid",
